...
function playRound(playerSelection, computerSelection) {
  ...
  if (updatedPS === updatedCS) {
    ...
    (updatedPS === "rock" && updatedCS === "scissors") ||
    (updatedPS === "paper" && updatedCS === "rock") ||
    (updatedPS === "scissors" && updatedCS === "paper")
  ) {
...
function game() {
  ...
  resultMessage.setAttribute(
    "style",
    "font-size : 30px; font-family : 'Roboto Mono', monospace; color : #03c07b; font-weight : bold; display : flex; justify-content : center;"
  );
  scoreDiv.setAttribute(
    "style",
    "display : flex; justify-content : flex-start; height : 170px; align-items : flex-end; "
  );
  displayScore.setAttribute(
    "style",
    "font-size : 30px; font-family : 'Roboto Mono', monospace; color : #03c07b; font-weight : bold;"
  );
